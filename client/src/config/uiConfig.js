...
export const THEMES = {
  ...
  solarized: { name: 'Solarized', bg: '#002b36', sidebar: '#073642', border: '#094857', text: '#93a1a1', textMuted: '#93aeb8', accent: '#2aa198', activityBar: '#01212b', statusBar: '#2aa198', editorTheme: 'octopus-solarized' },
  light:     { name: 'Light',     bg: '#ffffff', sidebar: '#f6f8fa', border: '#d0d7de', text: '#1f2328', textMuted: '#57606a', accent: '#0969da', activityBar: '#f0f0f0', statusBar: '#0969da', editorTheme: 'vs' },
};
